...
/datum/modpack/paperwork
	name = "Шредер для бумаг"
	desc = "Этот мод добавляет шредер для бумаги. Не вечно же нам сбрасывать бумагу в утиль?"
	author = "MrCat15352"
...
// Инициализация ДО
/datum/modpack/paperwork/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/paperwork/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/paperwork/post_initialize()
	. = ..()
