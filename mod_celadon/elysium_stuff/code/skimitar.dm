/obj/item/melee/skimitar
	...
	icon_state = "skimitar"
	item_state = "skimitar"
	icon = 'mod_celadon/elysium_stuff/icons/obj/skimitar.dmi'
	lefthand_file = 'mod_celadon/elysium_stuff/icons/mob/swords_lefthand.dmi'
	righthand_file = 'mod_celadon/elysium_stuff/icons/mob/swords_righthand.dmi'
