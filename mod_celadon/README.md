...
- [Модуляризация](#модуляризация)
		- [Если вы не будете следовать этому руководству, то с большой вероятностью ваш PR будет отклонён.](#если-вы-не-будете-следовать-этому-руководству-то-с-большой-вероятностью-ваш-pr-будет-отклонён)
	- [Введение](#введение)
