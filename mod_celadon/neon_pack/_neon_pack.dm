...
/datum/modpack/neon_pack
	name = "Neon pack"
	desc = "Добавляет структуры, лампы, вывески в стиле неона. Светящиеся неоновые декали. Свет в стиле неона."
	author = "MrCat15352"
...
// Инициализация ДО
/datum/modpack/neon_pack/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/neon_pack/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/neon_pack/post_initialize()
	. = ..()
