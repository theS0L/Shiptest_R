...
- `code/__DEFINES/~mod_celadon/layers.dm` Куча дефайнов для цветов обозначения для неона
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/neon_pack.dm`: `NEON_PACK_SPEED_MULTIPLIER`, `NEON_PACK_SPEED_BASE`
-->
