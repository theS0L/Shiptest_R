/obj/item/clothing/shoes/footwraps
	...
	icon = 'mod_celadon/items/icons/obj/shoes/miscellaneous.dmi'
	mob_overlay_icon = 'mod_celadon/items/icons/mob/shoes/miscellaneous.dmi'
	lefthand_file = 'mod_celadon/items/icons/obj/inhands/left_miscellaneous.dmi'
	righthand_file = 'mod_celadon/items/icons/obj/inhands/right_miscellaneous.dmi'
...
/obj/item/clothing/shoes/slippers
	name = "bunny slippers"
	desc = "Fluffy!"
	icon = 'mod_celadon/items/icons/obj/shoes/slippers.dmi'
	mob_overlay_icon = 'mod_celadon/items/icons/mob/shoes/slippers.dmi'
	lefthand_file = 'mod_celadon/items/icons/obj/inhands/left_slippers.dmi'
	righthand_file = 'mod_celadon/items/icons/obj/inhands/right_slippers.dmi'
	icon_state = "slippers"
	item_state = "slippers"
	force = 0
...
/obj/item/clothing/shoes/sandals
	...
	name = "sandals"
	icon = 'mod_celadon/items/icons/obj/shoes/sandals.dmi'
	mob_overlay_icon = 'mod_celadon/items/icons/mob/shoes/sandals.dmi'
	lefthand_file = 'mod_celadon/items/icons/obj/inhands/left_sandals.dmi'
	righthand_file = 'mod_celadon/items/icons/obj/inhands/right_sandals.dmi'
	icon_state = "sandals"
	item_state = "sandals"
