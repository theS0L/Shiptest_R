...
- https://github.com/CeladonSS13/Shiptest/pull/323
<!--
...
ID мода: CELADON_REPAIR_WEEBSTICK
<!--
...
Этот мод чинит красную катану. Weebstick (Красная катана) теперь нельзя сломать, 
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/repair_weebstick.dm`: `REPAIR_WEEBSTICK_SPEED_MULTIPLIER`, `REPAIR_WEEBSTICK_SPEED_BASE`
-->
