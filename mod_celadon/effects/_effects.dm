...
/datum/modpack/effects
	name = "Визуальные эффекты"
	desc = "Добавляет различные эффекты, частицы в игру. Нужен для работы некоторых модпаков."
	author = "MrCat15352"
...
// Инициализация ДО
/datum/modpack/effects/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/effects/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/effects/post_initialize()
	. = ..()
