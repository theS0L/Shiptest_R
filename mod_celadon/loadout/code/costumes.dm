/datum/gear/costume
	subtype_path = /datum/gear/costume
	slot = ITEM_SLOT_OCLOTHING
	sort_category = "Costumes"

/datum/gear/costume/costumes
	subtype_path = /datum/gear/costume/costumes

/datum/gear/costume/costumes/shark_costume
