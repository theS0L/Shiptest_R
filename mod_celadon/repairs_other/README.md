...
Этот мод содержит в себе мелкие изменения чинящие те или иные вещи, 
для которых не нашлось места в других паках.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/repairs_other.dm`: `REPAIRS_OTHER_SPEED_MULTIPLIER`, `REPAIRS_OTHER_SPEED_BASE`
-->
