...
/datum/modpack/lifeline_minus
	name = "Lifeline Minus"
	desc = "Замена Lifeline на его аналог с работой по радиусу."
	author = "PaintedCat"
...
// Инициализация ДО
//datum/modpack/lifeline_minus/pre_initialize()
//	. = ..()
//
// Инициализация ВОВРЕМЯ
//datum/modpack/lifeline_minus/initialize()
//	. = ..()
//
// Инициализация ПОСЛЕ
//datum/modpack/lifeline_minus/post_initialize()
//	. = ..()
