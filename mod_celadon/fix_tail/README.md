...
- `mod_celadon/fix_tail/code/suits.dm`: `flags_inv`
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/fix_tail.dm`: `FIX_TAIL_SPEED_MULTIPLIER`, `FIX_TAIL_SPEED_BASE`
-->
