...
/datum/modpack/celadon_modsuits
	name = "MOD Suits"
...
// Инициализация ДО
/datum/modpack/celadon_modsuits/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/celadon_modsuits/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/celadon_modsuits/post_initialize()
	. = ..()
