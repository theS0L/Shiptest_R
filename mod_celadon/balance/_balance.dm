/datum/modpack/balance
	name = "Balance"
	desc = "Вносит изменения в баланс. Затронуты кинетик Крашер, проджектайлы энергетических дробовиков, двигатели, радиационные коллекторы, универсальная плата для вендоров с карго, цены в карго, одежда с ЦК. Изменено количество получаемого лута с элиток. Изменения попаданий по лежачим. Убрано замедление у синдидюффелей. Вернули омнизин в синди сигареты."
