...
`code/modules/projectiles/guns/energy.dm` : `/obj/item/gun/energy/proc/insert_cell(mob/user, obj/item/stock_parts/cell/gun/C)` - Добавляем проверку на магазин среднего размера
