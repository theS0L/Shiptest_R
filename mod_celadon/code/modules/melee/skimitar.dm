/obj/item/melee/skimitar
	...
	icon_state = "skimitar"
	item_state = "skimitar"
	icon = 'mod_celadon/icons/obj/elisium/skimitar.dmi'
	lefthand_file = 'mod_celadon/icons/mob/inhands/weapons/swords_lefthand.dmi'
	righthand_file = 'mod_celadon/icons/mob/inhands/weapons/swords_righthand.dmi'
