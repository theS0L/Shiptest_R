...
/datum/modpack/boarding
	name = "Boarding"
	desc = "Добавляет телепад, позволяющий телепортироваться и брать на абордаж шаттлы других игроков. Также чинит механику взлома консоли управления мультитулом."
	author = "grozaandgrom (code), wuegue4ik (sprites)"
