...
/obj/structure/elite_tumor
	...
	var/potentialspawns = list(/mob/living/simple_animal/hostile/asteroid/elite/broodmother,
								// /mob/living/simple_animal/hostile/asteroid/elite/pandora,		//MOD_CELADON-CHANGES -> mod_celadon\code\modules\mob\dead\new_player\sprite_accessories\ipc.dm || BROKEN NEED FIX
