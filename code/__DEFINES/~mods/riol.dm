...
#define NOSERIOLCOLORS 1005
#define CHESTRIOLCOLORS 1006
#define BODYRIOLCOLORS 1007
...
#define RIOL_MASK_PATH 'mod_celadon/_storge_icons/icons/riol/clothing/mask.dmi'
#define RIOL_HEAD_PATH 'mod_celadon/_storge_icons/icons/riol/clothing/head.dmi'
#define RIOL_SUIT_PATH 'mod_celadon/_storge_icons/icons/riol/clothing/suit.dmi'
